...
export default function Ignored() {
  ...
  const removeUserfromIgnoredUserList = (user: User) => {
    dispatch(ignoreUser({ profileId: user.id })).finally(()=>{
      dispatch(getIgnoredProfileForUser());
    })
  ...
  return (
    <>
      ...
      <Box>
        ...
        <ProfileList ignoreIcon={false} setOpenMessage={setOpenMessage} openMessage={openMessage} list={ignoredUsers} me={null} handleClickOpenMessage={handleClickOpenMessage} handleLike={handleLike} selectedUser={selectedUser} likeIcon={true}
          handleCancelClick={removeUserfromIgnoredUserList} unblockProfile={() => console.log('unblcok no need here')} messageIcon={true} unblcokIcon={false} />
      </Box>
